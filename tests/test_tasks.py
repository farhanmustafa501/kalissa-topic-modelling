...
class TestCeleryTasks:
    ...
    def test_run_discovery_task_success(
        self, mock_session_local, mock_run_discovery, db_session, sample_collection, sample_discovery_job
    ):
    ...
    @patch("app.tasks.run_discovery")
    @patch("app.tasks.SessionLocal")
    def test_run_discovery_task_failure(
        self, mock_session_local, mock_run_discovery, db_session, sample_collection, sample_discovery_job
    ):
    ...
    @patch("app.tasks.run_discovery")
    @patch("app.tasks.SessionLocal")
    def test_run_discovery_task_already_completed(
        self, mock_session_local, mock_run_discovery, db_session, sample_collection, sample_discovery_job
    ):
    ...
    @patch("app.tasks.run_discovery")
    @patch("app.tasks.SessionLocal")
    def test_run_discovery_task_persist_failure_error(
        self, mock_session_local, mock_run_discovery, db_session, sample_collection, sample_discovery_job
    ):
