...
class TestAIService:
    ...
    def test_generate_topic_name_with_client(self, mock_get_client):
        ...
        mock_response.choices[0].message.content = (
            '{"name": "Test Topic", "summary": "Test summary", "keywords": ["test", "topic"]}'
        )
    ...
    def test_generate_topic_insights_with_client(self, mock_get_client):
        ...
        mock_response.choices = [MagicMock()]
        mock_response.choices[0].message.content = (
            '{"summary": "Test summary", "themes": ["theme1"], "questions": ["q1"], "related_concepts": ["concept1"]}'
        )
        mock_client.chat.completions.create.return_value = mock_response
    ...
    def test_answer_question_with_citations(self, mock_get_client):
        ...
        chunks = [{"id": "D1-C0", "text": "Test chunk text", "document_id": 1, "title": "Test Document"}]
